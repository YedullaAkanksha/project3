...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Product Code :</b>&nbsp;
<input type="text" name="pro_code"><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Product Name :</b>&nbsp;
<input type="text" name="pro_name" ><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b>Brand Name :</b>&nbsp;
<input type="text" name="pro_brand" ><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b>Product Price :</b>
...
&nbsp;&nbsp;&nbsp;<b>About Product :</b>
<input type="text" name="pro_about" ><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<a href="AfterAdminLogin.jsp" class="btn btn-outline-danger">Back</a>
